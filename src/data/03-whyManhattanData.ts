import bgImgSrc from '@/assets/images/manhattanBuilding.webp';
...
interface WhyManhattanSectionData {
  title: string;
  backgroundImage: {
    src: string;
    alt: string;
...
export const whyManhattanData: WhyManhattanSectionData = {
  title: 'WHY MANHATTAN?',
  backgroundImage: {
    src: bgImgSrc,
    alt: 'Empire State Building Manhattan',
  },
  articles: [
    {
      id: 'what-is-lorem',
